...
export const GENERAL_KEYS = ['wood','stone','clay','pottery','tools','goldOre','silverOre','copperOre','gold','silver','copper','scrolls','flour','oliveOil','salt','marble','tin','bronze','honey','wax','sugarcane','feathers','hide','leather','butter','cheese','cream','jam','candles','quilts','leatherGoods','statues','weapons','armour'];
