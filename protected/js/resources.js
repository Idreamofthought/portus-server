...
export const GENERAL_KEYS = ['wood','stone','clay','pottery','tools','goldOre','silverOre','copperOre','gold','silver','copper','scrolls','flour','oliveOil','salt','marble','tin','bronze','honey','wax','sugarcane','feathers','hide','leather','butter','cheese','cream','jam','candles','quilts','leatherGoods','statues'];
...
export const PRICES = {
  ...
  jam:2.4, candles:2.8, quilts:4.2, leatherGoods:5.4, statues:6.5,
...
export function createResources(){
  return {
    ...
    candles:0, quilts:0, leatherGoods:0, statues:0,
